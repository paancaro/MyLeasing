        ...
        private async Task CheckContractsAsync()
        {
            ...
            if (!_context.Contracts.Any())
            {
                _context.Contracts.Add(new Contract
                {
                    ...
                    "Nullam volutpat ultrices ex, sed cursus sem tincidunt ut. " +
                    "Nullam metus lorem, convallis quis dignissim quis, porttitor quis leo. " +
                    "In hac habitasse platea dictumst. Duis pharetra sed arcu ac viverra. " +
                    "Proin dapibus lobortis commodo. Vivamus non commodo est, ac vehicula augue. " +
